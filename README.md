# RJVim9 - Neovim Lua Port

A Neovim Lua port of the rjvim9.vim utility plugin, providing various helper functions and utilities for enhanced Vim/Neovim experience.

## Overview

This plugin has been converted from Vim9script to Lua for better Neovim integration and performance. It provides a comprehensive set of utility functions organized into several categories:
...
### Using packer.nvim
```lua
use 'path/to/vim-rjnvim'
```

### Manual Installation
1. Copy the `lua/` and `plugin/` directories to your Neovim configuration directory
2. Restart Neovim
...
This plugin maintains the same license as the original rjvim9.vim plugin.

## Contributing

Contributions are welcome! Please ensure:
- Lua code follows Neovim conventions
- Functions maintain compatibility with the original API
